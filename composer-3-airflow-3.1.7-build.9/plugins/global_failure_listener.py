"""
Airflow 3 Listener Plugin — Global task failure alerting.
...
HOW IT WORKS:
  Airflow 3 uses the Listener API (based on pluggy). You create a class
  with @hookimpl-decorated methods and register it via an AirflowPlugin.
    ...
    def on_task_instance_failed(self, previous_state, task_instance, error=None, session=None):
        ...
        try:
            alert = {
                ...
                "logical_date": str(task_instance.logical_date) if task_instance.logical_date else "",
